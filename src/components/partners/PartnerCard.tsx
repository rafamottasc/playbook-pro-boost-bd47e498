...
import { Building2, Phone, Mail, ExternalLink, FileText, Edit, Trash2 } from "lucide-react";
    ...
    <Card className="hover:shadow-lg transition-shadow">
      ...
      <CardContent className="space-y-4">
        {partner.manager_name && (
          <div>
            <p className="text-sm font-medium mb-2">Gerente:</p>
            <p className="text-sm text-muted-foreground">{partner.manager_name}</p>
          </div>
        )}
