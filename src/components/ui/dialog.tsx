...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:space-x-2 sm:gap-0 sticky bottom-0 bg-background pt-4 -mx-4 sm:-mx-6 px-4 sm:px-6 pb-0", className)} {...props} />
);
