    ...
    <Card className="group relative overflow-hidden border bg-gradient-card transition-smooth hover:shadow-lg hover:border-primary/50">
      <div className="p-4">
        ...
        <div className="space-y-2">
          ...
          {/* Feedback Icons - Row Below */}
          <div className="flex items-center justify-center gap-2">
            <Button
              variant={userFeedback === "like" ? "default" : "outline"}
              size="icon"
              onClick={handleLike}
              className={`h-9 w-9 ${userFeedback === "like" ? "bg-green-500 hover:bg-green-600 text-white border-green-500" : ""}`}
              title="Gostei"
            >
            ...
            <Button
              ...
              className={`h-9 w-9 ${userFeedback === "dislike" ? "bg-orange-500 hover:bg-orange-600 text-white border-orange-500" : ""}`}
              title="Não gostei"
            >
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" size="icon" className="h-9 w-9" title="Sugerir melhoria">
